  ...
  return (
    <div className="fixed top-4 right-4 sm:top-6 sm:right-6 z-50 glass-panel glow-border rounded-2xl p-4 sm:p-5 w-[calc(100vw-2rem)] sm:w-72 max-h-[75vh] sm:max-h-[80vh] overflow-y-auto">
      ...
      <div className="mb-3 sm:mb-4">
        <span className="text-[10px] font-mono uppercase tracking-widest text-primary/50 mb-1.5 sm:mb-2 block">Structure</span>
      ...
      {/* Animation */}
      <div className="mb-3 sm:mb-4">
        <span className="text-[10px] font-mono uppercase tracking-widest text-primary/50 mb-1.5 sm:mb-2 block">Animation</span>
        <div className="space-y-1.5 sm:space-y-2">
      ...
      {/* Growth */}
      <div className="mb-3 sm:mb-4">
        <span className="text-[10px] font-mono uppercase tracking-widest text-primary/50 mb-1.5 sm:mb-2 block">Growth</span>
        <div className="space-y-1.5 sm:space-y-2">
      ...
      {/* Visual */}
      <div className="mb-3 sm:mb-4">
        <span className="text-[10px] font-mono uppercase tracking-widest text-primary/50 mb-1.5 sm:mb-2 block">Visual</span>
        <div className="space-y-1.5 sm:space-y-2">
