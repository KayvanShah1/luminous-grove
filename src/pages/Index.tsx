		...
		<div className="relative min-h-screen overflow-hidden bg-background">
			...
			<div className="fixed inset-0 z-0">
				<div
					...
					style={{
						background:
							"radial-gradient(ellipse 120% 80% at 50% 100%, hsla(150, 30%, 8%, 0.8) 0%, transparent 60%)",
					}}
				/>
				<div
					className="absolute inset-0"
				...
				<div
					...
					style={{
						background:
							"repeating-conic-gradient(from 0deg at 50% 100%, hsl(150, 30%, 20%) 0deg 2deg, transparent 2deg 8deg)",
					}}
				/>
			</div>
